...
public class ReviveMission extends Mission {

    private List<String> rewardCommands;
    private int reward;
    private final Map<String, String> specs;

    public ReviveMission (String id, int amount, double chance, String displayName, String commandID,
    ...
    public void register() {
        ...
        if (this.getTimer() > 0) {
            ...
            MissionsHandler.reviveMissions.add(this);

        } else {

            MissionsHandler.permanentReviveMissions.add(this);
