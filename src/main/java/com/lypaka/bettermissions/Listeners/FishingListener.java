        ...
        if (event.optEntity.isPresent()) {
            ...
            if (event.isPokemon()) {
                ...
                if (AccountHandler.accountMap.containsKey(uuid)) {
                    ...
                    for (FishMission missions : MissionRegistry.fishMissions) {
                    ...
                    if (mission != null) {
                        ...
                        if (Utils.applies(mission.getSpecs(), pokemon.getPokemon())) {
                            ...
                            if (!requirementsEvent.isCanceled()) {
                                ...
                                ComplexConfigManager configManager = BetterMissions.missionConfigManager.get("Fish");
                                int index = Utils.getIndexFromMissionID("Fish", mission.getID());
                    ...
                    if (mission == null) {
                        ...
                        for (FishMission missions : MissionRegistry.permanentFishMissions) {

                            permanentMissions.removeIf(m -> {

                                if (m.equalsIgnoreCase(missions.getID())) {

                                    if (Utils.applies(missions.getSpecs(), pokemon.getPokemon())) {
                                        ...
                                        if (!requirementsEvent.isCanceled()) {
                                            ...
                                            ComplexConfigManager configManager = BetterMissions.missionConfigManager.get("Fish");
                                            int index = Utils.getIndexFromMissionID("Fish", missions.getID());
