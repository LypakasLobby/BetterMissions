            ...
            if (mission != null) {
                ...
                if (Utils.applies(mission.getSpecs(), pokemon)) {
                    ...
                    if (!requirementsEvent.isCanceled()) {
                        ...
                        ComplexConfigManager configManager = BetterMissions.missionConfigManager.get("Catch");
                        int index = Utils.getIndexFromMissionID("Catch", mission.getID());
                        ...
                        if (m.equalsIgnoreCase(missions.getID())) {
                            ...
                            if (Utils.applies(missions.getSpecs(), pokemon)) {
                                ...
                                if (!requirementsEvent.isCanceled()) {
                                    ...
                                    ComplexConfigManager configManager = BetterMissions.missionConfigManager.get("Catch");
                                    int index = Utils.getIndexFromMissionID("Catch", missions.getID());
