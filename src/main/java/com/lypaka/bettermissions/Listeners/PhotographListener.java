            ...
            if (mission != null) {
                ...
                if (Utils.applies(mission.getSpecs(), pokemon)) {
                    ...
                    if (!requirementsEvent.isCanceled()) {
                        ...
                        ComplexConfigManager configManager = BetterMissions.missionConfigManager.get("Photograph");
                        int index = Utils.getIndexFromMissionID("Photograph", mission.getID());
                        ...
                        if (m.equalsIgnoreCase(missions.getID())) {
                            ...
                            if (Utils.applies(missions.getSpecs(), pokemon)) {
                                ...
                                if (!requirementsEvent.isCanceled()) {
                                    ...
                                    ComplexConfigManager configManager = BetterMissions.missionConfigManager.get("Photograph");
                                    int index = Utils.getIndexFromMissionID("Photograph", missions.getID());
