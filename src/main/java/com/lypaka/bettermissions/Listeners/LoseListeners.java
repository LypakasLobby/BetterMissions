...
public class LoseListeners {
    ...
    public void onLoseToTrainer (LostToTrainerEvent event) throws ObjectMappingException {
        ...
        if (AccountHandler.accountMap.containsKey(uuid)) {
            ...
            for (LoseMission missions : MissionRegistry.loseMissions) {
            ...
            if (mission != null) {
                ...
                String entityType = mission.getEntityType();
                if (entityType.equalsIgnoreCase("npc") || entityType.equalsIgnoreCase("both")) {
            ...
            if (mission == null) {
                ...
                for (LoseMission missions : MissionRegistry.permanentLoseMissions) {

                    permanentMissions.removeIf(m -> {

                        if (m.equalsIgnoreCase(missions.getID())) {

                            String entityType = missions.getEntityType();
                            if (entityType.equalsIgnoreCase("npc") || entityType.equalsIgnoreCase("both")) {
    ...
    public void onLoseToPokemon (LostToWildPixelmonEvent event) throws ObjectMappingException {
        ...
        if (AccountHandler.accountMap.containsKey(uuid)) {
            ...
            if (mission != null) {
                ...
                String entityType = mission.getEntityType();
                if (entityType.equalsIgnoreCase("pokemon") || entityType.equalsIgnoreCase("both")) {
